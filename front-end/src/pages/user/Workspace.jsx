                ...
                <div className="bg-white p-3 w-3/4 h-full flex flex-col  space-y-5">
                    ...
                    {showChatUI && (
                        <>
                            <div className="overflow-y-auto space-y-3">
                                <div className="py-3 px-2 flex items-center space-x-2">
                                    {currentChosenUser && currentChosenUser?.profileImage && (
                                        <img src={
                                            isValidURL(currentChosenUser?.profileImage) ? 
                                                currentChosenUser?.profileImage
                                            :
                                                import.meta.env.VITE_COMMON_URL+currentChosenUser?.profileImage
                                        } 
                            ...
                            <ChatInputBox 
                                id={currentChannel?._id || currentChosenUser?._id}
                            />
                        </>
                    )}    
                </div>
